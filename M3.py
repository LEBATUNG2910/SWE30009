...
def convert_length(value, from_unit, to_unit):
    ...
    converted_value = value_in_meters * length_units[to_unit]  # Multiplied instead of divided
...
temperature_result = convert_temperature(25, 'celsius', 'fahrenheit')
print(f"25 Celsius in Fahrenheit: {temperature_result}")

temperature_result = convert_temperature(32, 'fahrenheit', 'kelvin')
print(f"32 Fahrenheit in Kelvin: {temperature_result}")