...
weight_result = convert_weight(1, 'kilogram', 'ounce')
print(f"1 kilogram in ounces: {weight_result}")
...
temperature_result_c_to_k = convert_temperature(25, 'celsius', 'kelvin')  # This will return None
