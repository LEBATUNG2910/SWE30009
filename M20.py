def convert_length(value, from_unit, to_unit):
    ...
    converted_value = value_in_meters / float(length_units['length_factors'][to_unit])  # Forced float division
...
def convert_weight(value, from_unit, to_unit):
    ...
    converted_value = value_in_kilograms / float(weight_units[to_unit])  # Forced float division
    return converted_value
